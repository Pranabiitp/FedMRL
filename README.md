...
Please download the ISIC 2018 using this  [link](https://challenge.isic-archive.com/data/#2018) and Messidor dataset using this [link](https://www.kaggle.com/datasets/mariaherrerot/messidor2preprocess/data).
